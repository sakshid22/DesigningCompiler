...
public class Scanner {
	...
	*/
	...
	private enum State {START, IN_DIV, IN_COLON, IN_LT, IN_GT, IN_EX, IN_ASTRK, IN_EQ, IN_IDEN, IN_DIGIT,
		                IN_COMMENT, IN_FLOAT};  //TODO:  this is incomplete
	...
	public Scanner scan() throws LexicalException {
		...
		keyMap.put("true", Kind.BOOLEAN_LITERAL);
		keyMap.put("false", Kind.BOOLEAN_LITERAL);	
                    ...
                    if(Character.isAlphabetic(ch) || Character.isDigit(ch) || ch == '$' || ch == '_') {
                        pos++;
                    	   ...
                    	   if(keyMap.containsKey(checkKey)) {
                    	       tokens.add(new Token(keyMap.get(checkKey), startPos, pos - startPos));
                    	   } else {
                    	   ...
                    	   state = State.IN_FLOAT;
                    	   	...
                    	   	BigInteger intValue = new BigInteger(String.copyValueOf(chars, startPos, pos-startPos));
            					if(BigInteger.valueOf(Integer.MAX_VALUE).compareTo(intValue) < 0){
            						error(pos, line(pos), posInLine(pos), "integer limit exceeded");
            					}
            					else{
                    ...
                    if(Character.isDigit(ch)) {
                        pos++;
                    	   ...
                    	   if(Float.isFinite(floatValue)) {
                    	   	...
                    	   	error(pos, line(pos), posInLine(pos), "floating point limit exceeded");
                    	   }
                    }
                }
                break;
