...
//			throw new SemanticException (declaration.firstToken, " declaration exception");
//		
//		if(symboltab.getScope(declaration.name) != -1) {
//			
//		}
//		
...
//	}
	...
	public Object visitDeclaration(Declaration declaration, Object arg) throws Exception {
		...
		if(declaration.type == Kind.KW_image && declaration.width != null) {
			...
			if(declaration.width.getType() != Type.INTEGER || declaration.height.getType() != Type.INTEGER) {
	...
	public Object visitStatementAssign(StatementAssign statementAssign, Object arg) throws Exception {
		...
		if(statementAssign.lhs.type != statementAssign.e.utiltype)    // or Type Type.Expression
	...
	public Object visitExpressionPixel(ExpressionPixel expressionPixel, Object arg) throws Exception {
		...
		expressionPixel.declaration = dec;
